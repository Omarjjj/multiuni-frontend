...
import { persist } from 'zustand/middleware'; // Optional: Persist state to localStorage
...
const useAppStore = create<AppState>()(
  // persist( // Uncomment to enable localStorage persistence
    ...
    // {
    //   name: 'multi-uni-assistant-storage', // Name of the item in localStorage
    //   // You might want to partially persist, excluding sessionId for example
    //   // partialize: (state) => ({ consideredMajors: state.consideredMajors, /* other persisted state */ }),
    // }
  // ) // End persist
);
